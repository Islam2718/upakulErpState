...
@Component({
  selector: 'app-component-mf-list',
  imports: [CommonModule, ReactiveFormsModule,ConfirmModalComponent],
  templateUrl: './mfComponent-list.component.html',
  styleUrl: './mfComponent-list.component.css'
})
export class ComponentMFListComponent implements OnInit, OnDestroy {
  qry: string | null = null
  //countries: Country[] = [];
  dataList: componentMF[] = [];
  page = 1;
  pageSize = 10;
  totalPages = 1;
  totalRecords = 0;
  ...
  //   console.log('In edit');
  //   console.log(editId);
  //   this.router.navigate(['master-product-form/edit'], { state: { editId: editId } });
  // }

  editData(mfId: number) {
   // console.log(mfId);
    this.router.navigate(['component-mf-form/edit'], { state: { mfId: mfId } });
  }
  ...
  loadList() {
    ...
    this.apiService.getComponentMFs(this.page, this.pageSize, this.searchForm.get('searchTerm')?.value, this.sortColumn, this.sortDirection)
      .pipe(
        tap(response => {
  ...
  navigateToCreate() {
    this.router.navigate(['mf/Component/component-mf-form']);
  }
