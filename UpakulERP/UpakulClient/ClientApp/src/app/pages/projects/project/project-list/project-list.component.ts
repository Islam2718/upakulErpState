...
import { ProjectService } from '../../../../services/Projects/project.service'; // Adjust path if needed
...
export class ProjectListComponent implements OnInit, OnDestroy {
  ...
  edit(editId: number) {
    // console.log('In edit');
    // console.log(editId);
    this.router.navigate(['/project/edit'], { state: { editId: editId } });
  }
// Confirmation modal for delete
  ...
  loadList() {
    ...
    this.apiService.getProjects(this.page, this.pageSize, this.searchForm.get('searchTerm')?.value, this.sortColumn, this.sortDirection)
      .pipe(
        tap(response => {
  ...
  navigateToCreate() {
    this.router.navigate(['pr/project/project']);
  }
