...
{
    public class LoanProposalGridQueryHandler : IRequestHandler<LoanProposalGridQuery, PaginatedResponse<LoanApplicationVM>>
    {
        private readonly ILoanApplicationRepository _repository;
        public LoanProposalGridQueryHandler(ILoanApplicationRepository repository)
        {
